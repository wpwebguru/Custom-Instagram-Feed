                ...
                <tr valign="top">
                    ...
                    <td class="sbi_connected_accounts_wrap">
                        ...
                        <div class="sbi_manually_connect_wrap">
                            ...
                            <p id="sbi_no_js_warning" class="sbi_notice"><?php echo sprintf( __('It looks like JavaScript is not working on this page. Some features may not work fully. Visit %sthis page%s for help resolving this issue.', 'instagram-feed'), '<a href="#">', '</a>' ); ?></p>
    ...
    <?php } // End Configure tab ?>
	    ...
	    <?php if( $sbi_active_tab == 'customize-posts' ) { //Start Customize Posts tab ?>
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    ...
                    <td>
                        ...
                        <p class="sbi_tooltip"><?php echo sprintf( __("Checking this box will change the link for each post to any url included in the caption for that Instagram post. The lightbox will be disabled. Visit %s to learn how this works.", 'instagram-feed'), '<a href="#">'. __( 'this link', 'instagram-feed' ) . '</a>' ); ?></p>
                    </td>
                </tr>
                <tr valign="top">
            ...
            <div>
                ...
                <span class="sbi_tooltip"><?php echo sprintf( __("Instagram is deprecating their old API for Personal accounts on June 1, 2020. The plugin supports their new API, however, some features (such as this one) are not yet available in their new API. If you require this feature then it is available if you convert your Instagram account from a Personal to a Business account by following %s.", 'instagram-feed'), '<a href="#">these directions</a>' ); ?></span>
                </p>
            </div>
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    ...
                    <td>
                        ...
                        <a class="sbi_tooltip_link" href="JavaScript:void(0);"><?php _e("What is this?", 'instagram-feed'); ?></a>
                        <p class="sbi_tooltip"><b><?php _e('Visual Moderation Mode', 'instagram-feed' ); ?></b><br /><?php echo sprintf( __("This adds a button to each feed that will allow you to hide posts, and create white lists from the front end using a visual interface. Visit %s for details", 'instagram-feed'), '<a href="#">' . __('this page', 'instagram-feed' ) . '</a>' ); ?></p>
